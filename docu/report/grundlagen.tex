...
Eine Erweiterung auf den dreidimensionalen Fall ergibt statt einer Ellipse einen Ellipsoiden, auch bistatischer Ellipsoid genannt. Abbildung~\ref{fig:bistatic_ellipsoid} zeigt exemplarisch einen solchen bistatischen Ellipsoid. Die Lösungen der Ellipsoidengleichung bilden die möglichen Positionen des Ziels für eine gegebene bistatische Entfernung.
