...
Eine Demonstration dieses Vorgangs ist in~\ref{fig:clean_signal} dargestellt.
...
\begin{figure}[htb]
    ...
    \subcaptionbox{Range/Doppler Matrix vor CLEAN Algorithmus\label{fig:clean_amb_before_2d}}{
        \includesvg[width=0.9\textwidth]{images/generated/clean_amb_before_2d.svg}
    }
